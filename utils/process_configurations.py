...
class ConfigurationParameters:
    ...
    def process_config(self):
        ...
        self.config_namespace.saved_model_dir = os.path.join("./experiments", self.config_namespace.exp_name,
                                                             "saved_models/")
        ...
        self.create_dirs(
            [self.config_namespace.graph_dir, self.config_namespace.image_dir, self.config_namespace.saved_model_dir])
